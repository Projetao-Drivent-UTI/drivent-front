      ...
      <TypesTicket>
        {ticketTypes?.map((type) =>
          type.name === 'Online' || type.name === 'Presencial' ? (
            <CardBox type={type} typeName={typeName} setTypeName={setTypeName} setTotal={setTotal} setTicketTypeId={setTicketTypeId} />
          ) : (
            ''
          )
        )}
          ...
          <TypesTicket>
            {ticketTypes?.map((type) =>
              type.name === 'Sem Hotel' || type.name === 'Com Hotel' ? (
                <CardHotels type={type} hotelName={hotelName} setHotelName={setHotelName} total={total} setTotal={setTotal} setTicketTypeId={setTicketTypeId} />
              ) : (
                ''
              )
            )}
